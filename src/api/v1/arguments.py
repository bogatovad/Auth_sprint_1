...
def create_parser_args_login():
    ...
    login_parser.add_argument(
        "login", **common_argument, required=True, help="Login required"
    )
    login_parser.add_argument(
...
def create_parser_args_change_auth_data():
    ...
    auth_change_parser.add_argument(
        "login", **common_argument, help="Login required to change"
    )
    auth_change_parser.add_argument(
        "password", **common_argument, help="Password required to change"
    )
