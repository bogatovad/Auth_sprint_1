...
def create_parser_args_signup():
    ...
    sign_up_parser.add_argument("login", **common_argument, required=True, help="Login required",)
    sign_up_parser.add_argument("password", **common_argument, required=True, help="Password required",)
    sign_up_parser.add_argument("email", **common_argument, required=True, help="Email required")
...
def create_parser_args_login():
    ...
    login_parser.add_argument("login", **common_argument, required=True, help="Login required")
